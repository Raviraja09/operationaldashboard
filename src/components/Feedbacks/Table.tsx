  ...
  const fetchPost = async () => {
    try {
      ...
      const res = await fetch(
        `https://diet-ideas-production.up.railway.app/v1/feedback?search=&page=1&page_size=10`,
        {
          method: "GET",
          headers: {
      ...
      data = datas.data.feedbacks;
      setUsers(datas.data.feedbacks);
      console.log(datas.data.feedbacks);
      // return data;
    } catch (error) {
      console.error(error);
    }
